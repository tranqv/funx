...
!
!     As testing with a large buffer size, we see larger buffer, it runs 
!     faster! This fact is true for huge input file size, but not true 
!     for tiny file size! --> NO now I doubt
!
      integer,parameter          :: lbuff =          1 * 1024  !   1 KB
