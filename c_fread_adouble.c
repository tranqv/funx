...
void  c_fread_adouble_ ( FILE **fp, double *ad, size_t *n, size_t *m )
{
...
void  c_fread_adouble_intref_ ( intptr_t *iptr, double *ad, size_t *n, size_t *m )
{
   size_t nc = (size_t) ( (*n) * sizeof(double) ) ; 
   size_t mc = (size_t) 1 ;
   *m = fread ( ad, nc, mc, (FILE *) (*iptr) );
}
