...
!-----
!
      subroutine  f_ferror ( file, istat ) 
!
...
!
!
      call c_ferror ( file % ptr, istat ) 
!
      return 
      end subroutine f_ferror
!
!-----------------------------------------------------------------------
!
!     Level 2:
...
!-----
!
      subroutine  f_ferror_intref ( iptr, istat ) 
!
...
!
      ...
      integer(kind=ck_int),intent(out)     :: istat
!
      external    c_ferror_intref 
!
!
      call c_ferror_intref ( iptr, istat ) 
!
      return 
      end subroutine f_ferror_intref
!
!
!-----------------------------------------------------------------------
