...
!     +  NOT WORK with binary file. 
!
!     Work fastly as much as t_fcopy_02. Btw, t_fcopy_02 seems be the fastest.
!
!     BUT IT was WRONG with Zip files! Use fputs() for ascii streams only.
!
      program t_fcopy_03 
!
      use my_funx 
...
!
 ...
 100  continue 
         ...
         call  funx_fputs ( file_o, str(1:lt), lt, istat ) 
